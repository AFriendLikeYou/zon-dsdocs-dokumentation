/**
 * Toggle — Paket-Barrel (`@zeit/components/toggle`).
 *
 ...
 * `@zeit/components/toggle/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`toggle.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
