/**
 * Icon Button — Paket-Barrel (`@zeit/components/icon-button`).
 *
 ...
 * `@zeit/components/icon-button/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`icon-button.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
