/**
 * Hero — Paket-Barrel (`@zeit/components/hero`).
 *
 ...
 * `@zeit/components/hero/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`hero.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
