/**
 * Button — Paket-Barrel (`@zeit/components/button`).
 *
 ...
 * `@zeit/components/button/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`button.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
