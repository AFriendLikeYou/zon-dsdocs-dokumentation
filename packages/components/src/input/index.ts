/**
 * Input — Paket-Barrel (`@zeit/components/input`).
 *
 ...
 * `@zeit/components/input/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`input.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
