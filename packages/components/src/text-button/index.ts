/**
 * Text Button — Paket-Barrel (`@zeit/components/text-button`).
 *
 ...
 * `@zeit/components/text-button/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`text-button.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
