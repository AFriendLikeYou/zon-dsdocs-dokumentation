/**
 * Stepper — Paket-Barrel (`@zeit/components/stepper`).
 *
 ...
 * `@zeit/components/stepper/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`stepper.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
