/**
 * Page Shortcut — Paket-Barrel (`@zeit/components/page-shortcut`).
 *
 ...
 * `@zeit/components/page-shortcut/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`page-shortcut.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
