/**
 * Checkbox — Paket-Barrel (`@zeit/components/checkbox`).
 *
 ...
 * `@zeit/components/checkbox/pattern.css` eingebunden: Styles gehören in den
 * Stylesheet-Graph des Konsumenten, nicht in einen JS-Import.
 *
 * Das Custom Element (`checkbox.ts`) folgt in PR 6 (MIGRATIONSPLAN.md §3).
 */
