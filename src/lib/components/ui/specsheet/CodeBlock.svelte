...
<style>
  ...
  */
  ...
  .cb-pre :global(.t-comment) { color: var(--cb-comment); font-style: italic; }
  .cb-pre :global(.t-tag) { color: var(--cb-tag); }
  .cb-pre :global(.t-attr) { color: var(--cb-attr); }
  .cb-pre :global(.t-string) { color: var(--cb-string); }
  .cb-pre :global(.t-property) { color: var(--cb-tag); }
  .cb-pre :global(.t-func) { color: var(--cb-attr); }
  .cb-pre :global(.t-number) { color: var(--cb-number); }
  .cb-pre :global(.t-selector) { color: var(--cb-selector); }
  .cb-pre :global(.t-brace) { color: var(--cb-brace); }
  .cb-pre :global(.t-punct) { color: var(--cb-punct); }
</style>
