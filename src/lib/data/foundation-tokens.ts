...
export const tokenName = (t: FoundationToken): string => (typeof t === 'string' ? t : t.name);
/** Normalisierung: Usage-Satz eines Tokens (leer, wenn nicht gepflegt). */
export const tokenUsage = (t: FoundationToken): string => (typeof t === 'string' ? '' : t.usage);
		...
		tokens: [
			{
				...
				usage: 'Grundfläche der Seite — Karten, Navbar, Eingabefelder in Ruhe (--ds-surface).'
			},
			{
			...
			},
			{
				...
				usage: 'Dritte, tiefer sitzende Ebene — aktive/gedrückte Flächen (--ds-surface-sunken).'
			},
			{
				name: '--z-ds-color-background-modal',
				usage: 'Ton für Modal-/Overlay-Flächen, die sich vom Seitenhintergrund abheben.'
			}
		]
	},
	{
		...
		tokens: [
			{
				...
				usage: 'Kräftiger Rahmen — Eingabefelder, Stepper, aktive Umrandungen (--ds-border-strong).'
			},
			{
				name: '--z-ds-color-border-70',
				usage: 'Ruhige Trennlinie zwischen Bereichen und Listenzeilen (--ds-border).'
			},
			{
				name: '--z-ds-color-border-hover',
				usage: 'Rahmenfarbe beim Hover interaktiver Flächen (--ds-border-hover).'
			},
			{
			...
			},
			{
				...
				usage: 'ZEIT-Rot als Fill/Akzent — Badges, Tipps, aktive Marker (--ds-accent-brand).'
			},
			{
				name: '--z-ds-color-accent-70',
				usage: 'Abgeschwächter Akzent — z. B. Hover-/Sekundärzustand des Akzents (Button).'
			}
		]
	},
	{
	...
	},
	{
		...
		tokens: [
			...
			},
			{
				...
				usage: 'Fehler/Don’t — rote Statusfarbe, u. a. für Eingabefehler (--ds-negative).'
			}
		]
	},
	{
		...
		tokens: [
			{
				...
				usage: 'Primärer Text — Überschriften und tragende UI-Beschriftung (--ds-text).'
			},
			{
	...
	},
	{
		...
		tokens: [
			...
			'--z-ds-fontsize-32',
			{
				...
				usage: 'Große Überschrift — Seiten-H1 (Brand-Display-Heading nutzt fontsize-42).'
			},
			'--z-ds-fontsize-36',
			'--z-ds-fontsize-42',
			'--z-ds-fontsize-46',
