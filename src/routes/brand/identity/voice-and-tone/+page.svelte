...
<svelte:head>
	<title>Voice & Tone - Die Zeit Design System</title>
</svelte:head>
...
<ul>
	...
	<li><strong>Fehler / Warnung</strong> — ruhig, lösungsorientiert, ohne Schuldzuweisung.</li>
	<li><strong>Onboarding / Leerzustand</strong> — einladend, orientierend.</li>
</ul>
