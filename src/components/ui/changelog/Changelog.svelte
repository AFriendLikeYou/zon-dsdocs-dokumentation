...
<style>
	...
	.changelog__header {
		...
		border-bottom: 1px solid var(--z-ds-color-border-100);
	}
	...
	.changelog__card__inner {
		...
		border-left: 1px solid var(--z-ds-color-border-100);
		border-right: 1px solid var(--z-ds-color-border-100);
		border-bottom: 1px solid var(--z-ds-color-border-100);
		border-bottom-left-radius: var(--z-ds-border-radius-8);
		border-bottom-right-radius: var(--z-ds-border-radius-8);
	}
	...
	.changelog__card-version {
		font-weight: bold;
		border-top-left-radius: var(--z-ds-border-radius-8);
		border-top-right-radius: var(--z-ds-border-radius-8);
