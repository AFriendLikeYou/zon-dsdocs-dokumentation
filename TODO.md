...
- [ ] **Stufe 4** — Registry-Schema (controls/template/pattern.css + Specimen-Escape), Migration der 4 z-*-Familien, Drift-Check-Update.
- [ ] **Stufe 5** — generierter Katalog-Index + neue Patterns (zon-teaser, cp-region, headed-meta, pager).
