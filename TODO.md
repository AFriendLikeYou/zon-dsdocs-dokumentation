...
- [ ] **Stufe 5** — generierter Katalog-Index (`src/data/catalog.ts` via glob + Override-Map) + neue Patterns (zon-teaser, cp-region, headed-meta, pager). _Anmerkung: date-picker/input („Geplant") flaggt der inverse Check, bis sie Modelle bekommen._
