...
bedeutet: *die Optik hat sich geändert*.
...
Grund: `threshold` ist die *Pro-Pixel-Farbtoleranz*; Karten- und Seitenfläche
...
Pixel — die Änderung war also sichtbar, nur nicht *messbar*.
